...
const Contacts = () => {
  ...
  console.log(event.target.email.value+" "+event.target.description.value+" "+event.target.object.value)
    location.href = "mailto:brahimvall.boumouzouna@etu.fstm.ac.ma"+'?cc='+event.target.email.value+'&subject='+event.target.object.value+'&body='+event.target.description.value;
          ...
          <div className="row d-flex justify-content-between">
            ...
            <div className="col-md-5 col-lg-5 justify-content-center">
              <form  onSubmit={sendRequest}>
                ...
                <button type="submit" className="mt-2 btn btn-block btn-outline-primary">
                  Leave a Request
                </button>
               </form>
            </div>
